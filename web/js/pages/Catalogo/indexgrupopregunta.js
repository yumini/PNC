...
var OptionButton=function(){
    this.routeList='_admin_grupopregunta_list';
...
OptionButton.prototype={
    New:function(){
        this.Window=new BootstrapWindow({id:"winForm",title:"Nuevo Grupo de Pregunta"});
        var url=Routing.generate(this.routeNew,{codcat:"GRUPOPREGUNTA"}); //:Tipo arbol
    ...
    Save:function(){
            var self=this;
            self.Window.Buttons(0).disabled();
            self.Window.Buttons(1).disabled();
            var url=Routing.generate(this.routeSave,{codcat:"GRUPOPREGUNTA"});
    ...
    Edit:function(id){
        this.IdEntity=id;
        this.Window=new BootstrapWindow({id:"winForm",title:"Editar Grupo de Pregunta"});
    ...
    Delete:function(id){
        this.IdEntity=id;
        if(confirm("Desea eliminar el grupo de pregunta seleccionado?")){
    ...
    Refresh:function(){
        ...
        new jAjax().Load(url,'main-body','get','GRUPOPREGUNTA','');
    }
}
