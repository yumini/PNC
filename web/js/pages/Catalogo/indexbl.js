...
var OptionButton=function(){
    this.routeList='_admin_ble_list';
...
OptionButton.prototype={
    New:function(){
        this.Window=new BootstrapWindow({id:"winForm",title:"Nuevo Base Legal Evaluador"});
        var url=Routing.generate(this.routeNew,{codcat:"BLE"}); //:Base Legal Evaluadr
    ...
    Save:function(){
            var url=Routing.generate(this.routeSave,{codcat:"BLE"});
    ...
    Edit:function(id){
        this.IdEntity=id;
        this.Window=new BootstrapWindow({id:"winForm",title:"Base Legal Evaluador"});
    ...
    Delete:function(id){
        this.IdEntity=id;
        if(confirm("Desea eliminar base legal evaluador seleccionado?")){
    ...
    Refresh:function(){
        ...
        new jAjax().Load(url,'main-body','get','BLE','');
    }
}
