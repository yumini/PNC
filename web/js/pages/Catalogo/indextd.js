...
var OptionButton=function(){
    this.routeList='_admin_tdi_list';
...
OptionButton.prototype={
    New:function(){
        this.Window=new BootstrapWindow({id:"winForm",title:"Nuevo Tipo Documento de Identidad"});
        var url=Routing.generate(this.routeNew,{codcat:"TDI"}); //Tipo Documento Identidad
    ...
    Save:function(){
            var url=Routing.generate(this.routeSave,{codcat:"TDI"});
    ...
    Edit:function(id){
        this.IdEntity=id;
        this.Window=new BootstrapWindow({id:"winForm",title:"Tipo Documento de Identidad"});
    ...
    Delete:function(id){
        this.IdEntity=id;
        if(confirm("Desea eliminar el tipo documento de identidad seleccionado?")){
    ...
    Refresh:function(){
        ...
        new jAjax().Load(url,'main-body','get','TDI','');
    }
}
