...
var OptionButton=function(){
    this.routeList='_admin_tcp_list';
...
OptionButton.prototype={
    New:function(){
        this.Window=new BootstrapWindow({id:"winForm",title:"Nuevo Tipo Contacto Postulante"});
        var url=Routing.generate(this.routeNew,{codcat:"TCP"}); //:Tipo Contacto Postulante
    ...
    Save:function(){
            var url=Routing.generate(this.routeSave,{codcat:"TCP"});
    ...
    Edit:function(id){
        this.IdEntity=id;
        this.Window=new BootstrapWindow({id:"winForm",title:"Tipo Contacto Postulante"});
    ...
    Delete:function(id){
        this.IdEntity=id;
        if(confirm("Desea eliminar el tipo contacto seleccionado?")){
    ...
    Refresh:function(){
        ...
        new jAjax().Load(url,'main-body','get','TCP','');
    }
}
